...
/* harmony import */ var _modules_init_busket__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-busket */ "./js/modules/init-busket.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    Object(_modules_init_busket__WEBPACK_IMPORTED_MODULE_6__["initBusket"])();
    Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_5__["initSliderMain"])();
...
/***/ "./js/modules/init-busket.js":
/*!***********************************!*\
  !*** ./js/modules/init-busket.js ***!
  \***********************************/
/*! exports provided: initBusket */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBusket", function() { return initBusket; });
var busketOpener = document.querySelector(".header__busket-opener");
var busket = document.querySelector(".busket");
var stand = document.querySelector(".stand");

var initBusket = function initBusket() {
  var busketCLoser = busket.querySelector(".busket__close");
  busketOpener.addEventListener("click", function () {
    ...
    stand.addEventListener("click", function () {
      ...
      stand.removeEventListener("click", function () {
        stand.classList.remove("stand--open");
        busket.classList.remove("open");
      });
    });
    busketCLoser.addEventListener("click", function () {
      stand.classList.remove("stand--open");
      busket.classList.remove("open");
      stand.removeEventListener("click", function () {
        stand.classList.remove("stand--open");
...
var initMobMenu = function initMobMenu() {
  var mainOpener = mainNav.querySelector(".main-nav__toggle");
  var mainClose = mainNav.querySelector(".main-nav__close");
  var mainWrapper = mainNav.querySelector(".main-nav__wrapper");
