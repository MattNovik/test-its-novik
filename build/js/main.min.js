...
var filterForm = document.querySelector(".filters__wrapper");
...
var initFilterSort = function initFilterSort() {
  ...
  Array.from(sortButtons).map(function (item) {
    item.addEventListener("click", function (e) {
      ...
      Array.from(productsList).map(function (item) {
      ...
      var newProductData = productsData.filter(function (item) {
        return filterFormData.every(function (k) {
          return item.type.split(" ").includes(k);
        });
      }).sort(sortFunctions[sortValue]);
      var newList = document.createElement("ul");
      newList.classList.add("catalog__list");
      newProductData.map(function (item) {
  ...
  filterForm.addEventListener("submit", function (e) {
    ...
    var _iterator2 = _createForOfIteratorHelper(formData.values()),
        _step2;
